...
run-asgi:
	uvicorn core.asgi:application --host 0.0.0.0 --port 1033 --reload
run:
	python manage.py runserver 0.0.0.0:1033
...
run-wsgi:
	gunicorn core.wsgi:application --bind 0.0.0.0:1033
tunnel:
	jprq http 1033 -s goride-api
open-bash:
